...
def test_bpe(model: bpe_tokenizer) -> None:
    ...
    for pair, rule in top_10:
        print(f"rank={rule.rank} : {pair} -> '{rule.merge}'")
...
def test_n_gram(model: n_gram) -> None:
    ...
    for t in temperatures:
        print("generated sentences with temperature =:",t,sep=" ",end="\n\n")
        for i in range(3):
            print(i+1,model.generate_sentence(30,t),sep=" : ",end="\n\n")
    ...
    test_input3 = """So she set the little creature down, and felt quite relieved to see it
    ...
    test_input4 = """‘But what about this Frodo that lives with him?’ asked Old
    ...
    test_input5 = """
                ...
                there lived within the green glades of Sherwood Forest, near Nottingham Town, a famous outlaw 
                whose name was Robin Hood. No archer ever lived that could speed a gray goose shaft with such 
                skill and cunning as his, nor were there ever such yeomen as the sevenscore merry men that roamed 
                with him through the greenwood shades. Right merrily they dwelled within the depths of Sherwood Forest, 
                suffering neither care nor want, but passing the time in merry games of archery or bouts of cudgel play, 
                living upon the King's venison, washed down with draughts of ale of October brewing. 
            """

    print("Perplexity Test",end="\n\n")
    ...
    print("excerpt from Alice in Wonderland:",end="\n\n")
    print("perplexity = ",model.perplexity(test_input3),sep=" ",end="\n\n")

    print("excerpt from Lord of the Rings:",end="\n\n")
    print("perplexity = ",model.perplexity(test_input4),sep=" ",end="\n\n")

    print("excerpt from Robinhood:",end="\n\n")
